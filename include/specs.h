#pragma once
#include <cstdint>    // for int16_t and co
#include <cstddef>     // for size_t and co 

// ===== Phase2 DAQ format (from your header) =====
namespace Phase2DAQ {
  ...
  static constexpr int SCLUSTER_ADDRESS_BITS_2S      = 8; // 7 addr + 1 seed/corr
...
// ===== Phase2 tracker specs (from your header) =====
namespace Phase2Spec {
  ...
  static constexpr int MODULES_PER_SLINK       = 18;  // equals CICs/2 (offset words)
